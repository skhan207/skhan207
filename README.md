...
<img src="https://i.imgur.com/7mggp13.png" height="80%" width="80%" alt="diagram"/>
<h2>Description</h2>
...
<img src="https://i.imgur.com/OwcwKWm.png" height="80%" width="80%" alt="set up"/>
<br />
<br />
...
<img src="https://i.imgur.com/KyycPe9.png" height="80%" width="80%" alt="set up"/>
<br />
<br />
Connect the Log Analytics Workspace to the VM:  <br/>
<img src="https://i.imgur.com/E5BAgRF.png" height="80%" width="80%" alt="set up"/>
<br />
<br />
Run the VM and connect to it via Remote Desktop Connection:  <br/>
<img src="https://i.imgur.com/NCZ52YE.png" height="80%" width="80%" alt="set up"/>
<br />
<br />
...
<img src="https://i.imgur.com/2zr1xR4.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
...
<img src="https://i.imgur.com/rXjvEzn.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Using the SQL Query in logs, observe the data from the custom log:  <br/>
<img src="https://i.imgur.com/vYV4Tz2.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Extract the fields from raw custom logs:  <br/>
<img src="https://i.imgur.com/Ih0Rb2m.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Check custom fields to confirm before testing:  <br/>
<img src="https://i.imgur.com/3HkDNB8.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
...
<img src="https://i.imgur.com/1w2dvYV.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Within Microsoft Sentinel, setup a map in workbooks using longitude and latitude:  <br/>
<img src="https://i.imgur.com/rHXBPxa.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Use the following SQL Query to isolate which data to be shown, and the following map settings to display on world map:  <br/>
<img src="https://i.imgur.com/h1kcegT.png" height="80%" width="80%" alt="workbook setup"/>
...
<img src="https://i.imgur.com/93WZ1j1.png" height="80%" width="80%" alt="Cyber Attack Event Management"/>
<br />
<br />
